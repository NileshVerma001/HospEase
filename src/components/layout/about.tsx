    ...
    <section className="max-w-7xl mx-auto p-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-lg leading-relaxed">
          At HealthConnect, our mission is to bridge the gap between patients and healthcare facilities. We aim to provide a comprehensive platform where users can easily find detailed information about hospitals, including available beds, specialties, and pricing. Our goal is to enhance transparency and accessibility in the healthcare sector, ensuring that everyone can find the care they need, when they need it.
        </p>
      </div>
      <div className="mb-8">
        <h2 className="text-2xl font-semibold mb-2">What We Offer</h2>
        <p className="text-lg leading-relaxed">
          HealthConnect is a one-stop solution for accessing up-to-date information on hospitals. Our platform allows users to:
        </p>
      ...
      <div className="mb-8">
        ...
        <p className="text-lg leading-relaxed">
          We love to hear from our users! Whether you have a question, feedback, or need assistance, please feel free to reach out to us at <a href="mailto:support@healthconnect.com" className="text-blue-500">support@healthconnect.com</a>.
        </p>
      </div>
